...
from .models import (
    ...
    NewsPost, ContactMessage, GalleryImage, Partner, FAQ, Testimonial, ImpactMetric, Location,SocialLink,CarouselSlide
)
...
class CarouselSlideAdmin(admin.ModelAdmin):
    list_display = ( 'is_active', 'created_on', 'preview')
...
class SocialLinkAdmin(admin.ModelAdmin):
    list_display = ('platform', 'url', 'profile', 'partner', 'is_visible',)
